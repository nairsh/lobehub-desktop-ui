export default {
  ...
  'desktop.openFloatingChat.desc': 'Open the floating compact chat window',
  'desktop.openFloatingChat.title': 'Floating Chat',
  ...
  'newChatTab.desc': 'Open a new in-app conversation tab',
  'newChatTab.title': 'New Conversation Tab',
