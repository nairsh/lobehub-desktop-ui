export default {
  ...
  'modelCouncil.settings.enabled.desc':
    'Use the selected council for prompts sent in Model Council mode.',
  'modelCouncil.settings.enabled.title': 'Enable Model Council',
  ...
  'modelCouncil.settings.models.reasoning': 'Reasoning',
  ...
  'modelCouncil.personality.researcher': 'Research explainer',
  'modelCouncil.personality.risk': 'Risk auditor',
  'modelCouncil.personality.skeptic': 'Skeptical reviewer',
  ...
  'settingsTabNotFound.action': 'Open profile settings',
  'settingsTabNotFound.desc': 'This settings section is not available in the desktop app.',
  'settingsTabNotFound.title': 'Settings section not found',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.memory': 'Memory',
  'tab.modelCouncil': 'Model Council',
