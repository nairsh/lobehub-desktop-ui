export default {
  ...
  'builtins.lobe-cloud-sandbox.export.download': 'Download',
  'builtins.lobe-cloud-sandbox.export.exported': 'Exported: {{filename}}',
  'builtins.lobe-cloud-sandbox.export.failed': 'Failed to export {{path}}',
  'builtins.lobe-cloud-sandbox.export.openArtifact': 'Open artifact',
  'builtins.lobe-cloud-sandbox.export.preview': 'Preview',
  ...
  'builtins.lobe-activator.apiName.searchTools': 'Search Tools',
