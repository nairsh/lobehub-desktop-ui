export default {
  ...
  'owner': 'Group owner',
  'pageCopilot.clear': 'Clear conversation',
  'pageCopilot.dock': 'Dock to side',
  'pageCopilot.float': 'Float',
  'pageCopilot.minimize': 'Minimize',
  'pageCopilot.more': 'More',
  'pageCopilot.newBadge': 'New',
  'pageCopilot.newChat': 'New AI chat',
  'pageCopilot.open': 'Open AI chat',
  'pageCopilot.share': 'Share',
  'pageCopilot.shareCopied': 'Link copied to clipboard',
  'pageCopilot.suggestion.analyze': 'Analyze for insights',
  'pageCopilot.suggestion.analyzePrompt':
    'Analyze this page and surface the key insights, patterns, and anything notable.',
  'pageCopilot.suggestion.createAgent': 'Create custom agent',
  'pageCopilot.suggestion.createAgentPrompt':
    'Help me create a custom AI agent. Ask me what role, tone, and capabilities it should have.',
  'pageCopilot.suggestion.createDiagram': 'Create a diagram based on page',
  'pageCopilot.suggestion.createDiagramPrompt':
    'Create a Mermaid diagram that captures the structure and key ideas of this page.',
  'pageCopilot.suggestion.summarize': 'Summarize this page',
  'pageCopilot.suggestion.summarizePrompt': 'Summarize this page into a few clear bullet points.',
  ...
  'pageCopilot.welcomeTitle': 'What can I brighten up for you today?',
  ...
  'runtimeEnv.cloudConfig.apiKeyLabel': 'API Key',
  'runtimeEnv.cloudConfig.apiKeyPlaceholder': 'Optional if your Open Terminal is public',
  ...
  'runtimeEnv.cloudConfig.urlRequired': 'Please enter your Open Terminal URL',
  ...
  'mode.group-builder': 'Group Builder',
  'mode.none': 'No Mode',
  'mode.self-iteration': 'Self Iteration',
  'mode.title': 'Modes',
