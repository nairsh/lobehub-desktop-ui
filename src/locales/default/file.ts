export default {
  ...
  'pageEditor.editedAtTimeFormat': 'MMM D, YYYY [at] h:mm A',
  'pageEditor.editedBy': 'Last edited by {{name}}',
  'pageEditor.editorPlaceholder': 'Type "/" for commands',
  ...
  'pageEditor.menu.font.default': 'Default',
  'pageEditor.menu.font.mono': 'Mono',
  'pageEditor.menu.font.serif': 'Serif',
  'pageEditor.menu.importDocument': 'Import Page',
  'pageEditor.menu.pin': 'Pin Page',
  'pageEditor.menu.smallText': 'Small text',
