...
const PortalPanel = memo(({ children }: PropsWithChildren) => {
  const [showPortal, showToolUI, showArtifactUI, showThread, showTerminalWorkspace] = useChatStore(
    (s) => [
      ...
      chatPortalSelectors.showTerminalWorkspace(s),
    ],
  );
  ...
  return (
    <DraggablePanel
      ...
      minWidth={
        showArtifactUI || showToolUI || showThread || showTerminalWorkspace
          ? CHAT_PORTAL_TOOL_UI_WIDTH
          : CHAT_PORTAL_WIDTH
      }
